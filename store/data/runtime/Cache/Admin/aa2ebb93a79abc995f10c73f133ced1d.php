...
<body class="J_scroll_fixed">
	<div class="wrap J_check_wrap">
		<ul class="nav nav-tabs">
			<li class="active"><a href="<?php echo U('asset/index');?>">附件列表</a></li>
			<?php if(sp_auth_check($admin['id'],"/admin/asset/add")){ ?>
				<li><a href="<?php echo U('asset/add');?>">添加附件</a></li>
			<?php } ?>
		</ul>
		<form class="well form-search" method="post" action="<?php echo U('asset/index');?>">
		...
		<table class="table table-hover table-bordered table-list">
			...
			<?php if(is_array($list)): foreach($list as $key=>$vo): ?><tr>
				...
				<td><?php switch($vo["cate"]): case "0": ?>其他<?php break; case "1": ?>文档<?php break; case "2": ?>图片<?php break; case "3": ?>视频<?php break; endswitch;?></td>
				...
				<td>
					...
					<?php if(sp_auth_check($admin['id'],"/admin/asset/delete")){ ?>
