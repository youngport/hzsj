...
<div class="wrap">
  ...
  <div class="home_info">
    <ul  id="thinkcmf_notices">
      <li>
        <h5>尊敬的<span class="text-success"><?php echo ((isset($admin["user_nicename"]) && ($admin["user_nicename"] !== ""))?($admin["user_nicename"]):$admin[user_login]); ?></span>,您好</h5>
        <p>
          <?php if(($xiaoxi) == "0"): ?>暂时没有新消息
          <?php else: ?>
            您还有<?php echo ($xiaoxi); ?>条消息没有查看,<a href="<?php echo U('message/index');?>">赶紧点开查看吧</a><?php endif; ?>
        </p>
      </li>
    </ul>
  </div>
  <?php if(($_SESSION['name']) == "admin"): ?><h4 class="well">系统信息</h4>
      <div class="home_info">
        <ul>
