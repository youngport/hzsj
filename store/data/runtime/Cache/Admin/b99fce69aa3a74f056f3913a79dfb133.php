...
<![endif]-->
<link rel="stylesheet" href="/store/statics/simpleboot/themes/<?php echo C('SP_ADMIN_STYLE');?>/simplebootadminindex.min.css?">
<!--[if lte IE 8]>
	<link rel="stylesheet" href="/store/statics/simpleboot/css/simplebootadminindex-ie.css?" />
<![endif]-->
<style>
...
<body style="min-width:900px;" screen_capture_injected="true">
	...
	<div class="navbar">
		<div class="navbar-inner">
			<div class="container-fluid">
				<a href="/store/index.php?g=admin&m=index&a=index" class="brand"> <small> 
				<img src="/store/statics/images/icon/logo-18.png">
						商家后台
				</small>
				</a>
				...
				<ul class="nav simplewind-nav pull-right">
					<li class="light-blue">
						<a data-toggle="dropdown" href="#" class="dropdown-toggle">
							<img class="nav-user-photo" src="/store/statics/images/icon/logo-18.png" alt="<?php echo ($admin["user_login"]); ?>">
						...
						<ul class="user-menu pull-right dropdown-menu dropdown-yellow dropdown-caret dropdown-closer">
							...
							<li><a href="javascript:openapp('<?php echo U('feedback/add');?>','feedback_add','联系我们');"><i class="fa fa-user"></i> 联系我们</a></li>
	...
	<script src="/store/tpl_admin/simpleboot/assets/js/index.js"></script>
