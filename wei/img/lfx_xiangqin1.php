...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        <div class="dazonghe" id="dazonghe">
            <!--            <div id="top_p"></div>-->
            <div class="biaoti"><img src="<?php if($data['openid']=='0'){ echo '../../img/admintouxiang.png';}else{ echo $data['headimgurl'];} ?>" /><span ><?php if($data['openid']=='0'){ echo '管理员';}elseif($data['openid']==''){ echo '匿名用户'; }else{ echo  $data['wei_nickname'];} ?></span></div>
            <?php
            //var_dump($cookieArr);
