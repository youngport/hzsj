...
include '../../../base/commonFun.php';
	...
	if($notify->checkSign() == TRUE)
	{
		...
		elseif($notify->data["result_code"] == "FAIL"){
			...
			//结算后，减去商品库存
            $sql = "select k.goods_id,k.quantity,g.kucun from sk_orders o left join sk_order_goods k on k.order_id=o.order_id left join sk_goods g on g.id=k.goods_id where o.order_sn='$out_trade_no'";			
            ...
            //是否收益抵扣，更新收益余额
				if ($resuArr[0]['is_shouyi'] ==1) {
					...
					$ug_shouyi['shouyi'] -= $resuArr[0]['syq_price'];
