...
<table class="top">
    <tr>
        <td align=center valign=middle><a href="keliu.php"><span>昨日统计</span></a></td>
        <td width=34% align=center valign=middle><span style="border-bottom:0.2em solid #579acb;">本周统计</span></td>
...
<!-- <table class="tongji_yuan">
    <tr>
        <td align=center valign=middle>
            <div class="daoru_yuan" id="daoru_yb">
            </div>5/9
        </td>
        <td align=center valign=middle>
            <div class="daoru_yuan" id="xiaofei_yb">
            </div>4/9
        </td>
    </tr>
</table> -->
    ...
    $.ajax({
    	...
    	success: function(data){
			...
			if(data.mac!=0){
    			...
    			var jiu_fanke_tu = data.jiu_fanke_tu.split(",");
    			var zx_tu = data.zx_tu.split(",");
    			var xiabiao_tu = data.xiabiao_tu.split(",");	
    		    var total_fanke_tu = new Array(); //总访客曲线图		
    
                for(var i=0;i<xiabiao_tu.length;i++){  
                	xiabiao_tu[i] = xiabiao_tu[i].replace(/'/g,"");
                } 
