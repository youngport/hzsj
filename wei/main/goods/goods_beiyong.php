...
function addToCart(){
	...
	$.ajax({
		...
		data: "goodsid=<?php echo $id ?>&guige="+guige+"&ms=<?php if($huodong){echo 1;}else{echo 2;}?>&color="+color+"&sul="+$('#number').val(),
...
<table class="rigou">
	...
	<?php }else{?>
		<td class="houwu" style="background:#c4c1c1;" onclick="addToCart();"><img src="<?php echo $cxtPath;?>/wei/img/gwc.png" /></td>
    ...
    <div class="gmcs_top">
        ...
        <div class="gmcs_top_txt">
            ...
            <div class="gmcs_jiage">
                <?php if($id_goodstype==3){ echo $goodArr[0]["dhjifen"];}else if($huodong){ "￥".$goodArr[0]["huodongjia"]; }else{ echo "￥".$goodArr[0]["price"];} ?>
            </div>
