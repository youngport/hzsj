...
<div style="background:#fff;">
    ...
    <div class="text_input">姓名:<input class="text" name="name" id="name" type="text"><span>*必填</span></div>
    <div style="border-top:1px solid #edecec;width:90%;margin:0 auto;"></div>
    <div class="text_input">联系电话:<input class="text" name="shouji" id="shouji" type="text"><span>*必填</span></div>
    <div style="border-top:1px solid #edecec;width:90%;margin:0 auto;"></div>
    <div class="text_input">微信号:<input class="text" name="weixinqq" id="weixinqq" type="text"><span>*必填</span></div>
    <div style="border-top:1px solid #edecec;width:90%;margin:0 auto;"></div>
    <div class="text_input">联系地址:<input class="text" name="dizhi" id="dizhi" type="text"><span>*必填</span></div>
	<div style="border-top:1px solid #edecec;width:90%;margin:0 auto;"></div>
	<div class="text_input">上传营业执照:<input name="business" id="business" accept="image/jpg,image/jpeg,image/png,image/gif" type="file" style="width:50%"><span>*必填</span></div>
	<div style="border-top:1px solid #edecec;width:90%;margin:0 auto;"></div>
	<div class="text_input">上传店招:<input name="dianzhao" id="dianzhao" accept="image/jpg,image/jpeg,image/png,image/gif" type="file" style="width:50%"><span>*必填</span></div>
	<div style="border-top:1px solid #edecec;width:90%;margin:0 auto;"></div>
    <div style="border-top:1em solid #edecec;width:100%;margin:0 auto;"></div>
    <div class="text_input">代理人姓名:<input class="text" name="dailiren" id="dailiren" type="text"></div>
    <div style="border-top:1px solid #edecec;width:90%;margin:0 auto;"></div>
    <div class="text_input">代理人号码:<input class="text" name="dailihaoma" id="dailihaoma" type="text"></div>
	</form>
</div>
