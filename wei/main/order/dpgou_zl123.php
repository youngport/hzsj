...
<head>
	...
	<script type="text/javascript" src="<?php echo $cxtPath ?>/wei/js/h5uploader.js"></script>
...
<div style="background:#fff;">
	...
	<div class="text_input">上传营业执照:<input name="business" id="business" type="file" style="width:50%"><span>*必填</span></div>
	<div style="border-top:1px solid #edecec;width:90%;margin:0 auto;"></div>
	<div class="text_input">上传店招:<input name="dianzhao" id="dianzhao" type="file" style="width:50%"><span>*必填</span></div>
...
<script type="text/javascript">
    var uploader = document.getElementById('wancheng');
        uploader.addEventListener("click", function(e) {

        H5Uploader.upload({
            action: 'dpgou_zlget.php',
            id: 'business',
            size: {
                max: 5000, // 5000kb 
                valide: function(e) {
