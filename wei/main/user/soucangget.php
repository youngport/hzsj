...
if($_POST['type']==0){
	...
	//$sql = "select sk_goods.good_name,sk_goods.img,sk_goods.id,sk_soucang.id sid from sk_goods join sk_soucang on sk_soucang.chanpin=sk_goods.id where sk_soucang.yonghu='$openid' and sk_soucang.type=1";
