...
if($_GET['cate_id']){
   ...
   $ajaxdata .= "cate_id:'".$cate_id."'";
   $ssk .= "cate_id:'".$cate_id."'";
}
if($_GET['mp_cate_id']){
    $mp_cate_id = $_GET['mp_cate_id'];
     $ajaxdata .= ",mp_cate_id:'".$mp_cate_id."'";
      $ssk .= ",mp_cate_id:'".$mp_cate_id."'";
}
if($_GET['nation_id']){
    $nation_id = $_GET['nation_id'];
     $ajaxdata .= ",nation_id:'".$nation_id."'";
       $ssk .= ",nation_id:'".$nation_id."'";
}
if($_GET['mp_id']){
   $mp_id = $_GET['mp_id'];
    $ajaxdata .= ",mp_id:'".$mp_id."'";
     $ssk .= ",mp_id:'".$mp_id."'";
