...
$id = intval($_GET['spid']);
$sql = "select lfx.biaoti,lfx.neirong,lfx.shijian,lfx.openid,lfx.dianji,me.wei_nickname,me.headimgurl,(select count(*) from sk_lfx_dz where lfxid=lfx.id) dianzan,(select count(*) from sk_lfx_pinglun where lfx_id=lfx.id ) pinlun from sk_lfx lfx left join sk_member me on me.open_id=lfx.openid where lfx.id='$id'";
$data = $do->getone($sql);
    ...
    <head>
        ...
        <meta name="viewport" content="width=320, initial-scale=1.0, maximum-scale=1.0, user-scalable=no">
            ...
            <script type="text/javascript">
                ...
                wx.ready(function(){
                    var shareData = {
                        title: "洋仆淘O2O跨境商城－乐分享",
                        desc: "<?php echo $data['biaoti']; ?>", // 分享描述
