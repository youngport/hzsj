...
//                                shopStr += '        </div>';
                                ...
                                shopStr += '    <div style="width:20%;text-align: right;" class="dianzan" data-dzcs="'+data[i].dianzan+'" data-dzid="'+data[i].id+'"><img src="../../css/img/good.png"/>&nbsp;<span>' + data[i].dianzan + '</span>&nbsp;</div>';
