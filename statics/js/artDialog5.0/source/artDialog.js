...
artDialog.fn = artDialog.prototype = {
    ...
    */
    title: function (content) {
        ...
        if (content === false) {
			...
			this.dom.content.addClass('d-message');
			this.dom.titleBar.removeClass('d-titleBar');
			this.dom.close.hide();
        } else {
            $title.show().html(content);
            outer.removeClass(className);
			this.dom.content.removeClass('d-message');
			this.dom.titleBar.addClass('d-titleBar');
        };
    ...
    */
    ...
    _getDom: function () {
        ...
        wrap.style.cssText = 'position:absolute;left:0;top:0;box-shadow:none;';
