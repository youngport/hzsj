-function() {
	...
	creElm( {
		href : '/statics/js/share/css1.css',
		rel : 'stylesheet',
		type : 'text/css'
	}, 'link');
	sharetoBtnContain = {
		...
		over : function(e) {
			...
			if (!clickpopjs) {
				clickpopjs = creElm( {
				    src: '/statics/js/share/shareto_button_menu.js',
					charset : 'utf-8'
				}, 'script', head);
		...
		center : function() {
			if (!this.script) {
				this.script = creElm( {
				    src: '/statics/js/share/shareto_button_window.js',
					charset : 'utf-8'
				}, 'script', head);
...
//						+ (screen.height - 500) / 2);
		...
		(function() {
			var url = 'link=http://www.shareto.org/&source='
