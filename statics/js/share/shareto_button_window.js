    ...
    sharetoBtnContain.centerpop.innerHTML = '<div style="border:10px solid #7F7F7F; width:300px;">\
		<div class="shareto_div_01" style="width:100%;">\
			<div style="background:#F2F2F2;line-height:200%;padding-left:5px;">\
				...
				<div style="float:right"><img src="http://www.shareto.org/img/img_exit.gif" border="0" style="margin:4px 4px 0 0;cursor:pointer;" onclick="sharetoBtnContain.centerClose()"/></div>\
				<div style="clear:both;height:0;"></div>\
			</div>\
			<div style=" background:#F2F2F2;border-bottom:1px solid #E5E5E5;padding-left:5px;">\
				<div style="background:url(http://www.shareto.org/img/img_so.gif) no-repeat center;height:30px; width:281px">\
...
<div style="clear:both"></div>\
			...
			<div style="background:#F2F2F2;border-top:1px solid #E5E5E5;line-height:120%;padding-left:5px;">\
				<div style="width:120px;float:left;font-size:10px"><a href="http://www.shareto.org/intro.html" class="link_01" style="color:#333333;" target="_blank">这是什么工具?</a></div>\
