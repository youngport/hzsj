...
<head>
    ...
    <title>微网网站后台管理</title>
    <link href="__ROOT__/statics/admin/css/style.css" rel="stylesheet" type="text/css"/>
    <link href="__ROOT__/statics/admin/css/login.css" rel="stylesheet" type="text/css"/>
</head>
<body>
<div id="login">
    <div style=" width: 200px;position: relative;top: 123px; color: #fff; font-size: 20px; ">
        <h2>微商网站后台登录</h2>
    </div>
    <form action="<?php echo u('public/login');?>" method="post" id="myform">
        ...
        <dl>
            ...
            <?php if($set["check_code"] == '1'): ?><dd>验　证　码：<input id="verify" type="text" name="verify">
                    <img id="verify_img" src="<?php echo U('verify/verify',array('rand'=>time()));?>" title="看不清？点击刷新"
                         onclick="javascript:this.src='<?php echo U('verify/verify/');?>&mt='+Math.random()"/>
                </dd><?php endif; ?>
